...
/* dummy post - for debug*/
                $data ['guestbook'] = [
                    'name_of_writer' => 'name_of_writer',
                    'email' => 'name_of_writer',
                    
                    'message_text'  => 'name_of_writer',
                    'picture_name' =>'name_of_writer', //$newName , //$newName, //  or if orignal upload name is $news_image->usedgetClientName(),
                    'picture_type'  => 'name_of_writer',
                    'id' =>  $id ] ;
               
                echo view('templates/header');
                echo view('pages/delete_guestbook_article', $data );
                echo view('templates/footer');
